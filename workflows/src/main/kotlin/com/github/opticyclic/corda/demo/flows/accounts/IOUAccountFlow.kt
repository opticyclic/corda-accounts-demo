...
@InitiatingFlow
@StartableByRPC
class IOUAccountFlow(val iouValue: Int, val counterparty: Party) : FlowLogic<SignedTransaction>() {
    /**
    ...
    override fun call(): SignedTransaction {
        ...
        //Create the output.
        val iouState = IOUAccountState(iouValue, serviceHub.myInfo.legalIdentities.first(), counterparty)
